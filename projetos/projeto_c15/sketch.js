...
//Adicione a condição para gameState = PLAY
  ...
  if (World.frameCount % 100 == 0) {
    switch(select_balloon ){
      case 1:createBalloon(which_balloon=red_balloonImage, balloon_scale=0.1, balloon_velocityX=3);
      break;
      case 2:createBalloon(which_balloon=blue_balloonImage, balloon_scale=0.1, balloon_velocityX=3);
      break;
      case 3:createBalloon(which_balloon=pink_balloonImage, balloon_scale=1, balloon_velocityX=3);
      break;
      case 4:createBalloon(which_balloon=green_balloonImage, balloon_scale=0.1, balloon_velocityX=3);
      break;
      default:break;
    }
  }
