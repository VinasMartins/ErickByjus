...
function setup() {
	...
	plane = Bodies.rectangle(600, height, 1200, 20, opitions);
	World.add(world, plane);

	block1 = Bodies.rectangle(100, 400, 150, 20, opitions);
	World.add(world, block1);

	block2 = Bodies.rectangle(400, 400, 150, 20, opitions);
	World.add(world, block2);

	rotator1 = Bodies.rectangle(250, 200, 150, 20, opitions);
	World.add(world, rotator1);

	rotator2 = Bodies.rectangle(250, 200, 150, 20, opitions);
	World.add(world, rotator2);

	rotator3 = Bodies.rectangle(250, 200, 150, 20, opitions);
